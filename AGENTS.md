...
When the captain invokes `/fresh-start`, load the `fresh-start` skill for its report-first fleet restart procedure, guarded preservation and cleanup, supported updates, home reopening, and when-safe rechecks.
